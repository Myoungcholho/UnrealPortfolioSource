...
**요약**
- [언리얼 GC·UPROPERTY 이해 부족으로 인한 크래시](#ts-gc)
- [미세 버그를 “나중에”로 미룬 점](#ts-bug)
- [문제 해결 과정을 기록하지 않은 점](#ts-doc)

---

### 1. 언리얼 아키텍처에 대한 깊은 이해 없이 프로젝트를 시작한 점 <a id="ts-gc"></a>
...
### 2. 미세 버그를 “나중에 고치자”고 넘겼던 점 <a id="ts-bug"></a>
...
### 3. 문제 해결 과정을 충분히 기록하지 않았던 점 <a id="ts-doc"></a>
이번 언리얼 프로젝트에서는</br>
...
**요약**
- [구조 설계 & 디자인 패턴 활용 역량](#gain-structure)
- [데이터 중심 구조 설계 경험](#gain-data)
- [액션 게임 콘텐츠 개발 경험](#gain-action)
- [MVVM 기반 UI 구조 설계 역량](#gain-mvvm)

---

### 1. 구조 설계 & 디자인 패턴 활용 역량 <a id="gain-structure"></a>
...
### 2. 데이터 중심 구조 설계 경험 <a id="gain-data"></a>
데이터 에셋과 테이블을 활용해</br>
...
### 3. 액션 게임 콘텐츠 개발 경험 <a id="gain-action"></a>
...
### 4. MVVM 기반 UI 구조 설계 역량 <a id="gain-mvvm"></a>
...
### 1. 빠른 공격 모션에서 타격 누락 문제 (Hit Detection 안정화) <a id="ts-hit"></a>
...
### 2. 암살 몽타주 관리 구조 문제 → 세트 기반 구조로 리팩토링 <a id="ts-assassinate"></a>
